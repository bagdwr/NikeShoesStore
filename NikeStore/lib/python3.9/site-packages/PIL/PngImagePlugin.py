...
# 1998-07-12 fl   Read/write 16-bit pictures as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB pictures
    ...
    def seek(self, frame):
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                raise EOFError("no more pictures in APNG file") from e
    ...
    def _seek(self, frame, rewind=False):
        if frame == 0:
            ...
            while True:
                ...
                if cid == b"IEND":
                    raise EOFError("No more pictures in APNG file")
                if cid == b"fcTL":
                    if frame_start:
...
def _save(im, fp, filename, chunk=putchunk, save_all=False):
    ...
    if mode == "P":
        ...
        #
        # attempt to minimize storage requirements for palette pictures
